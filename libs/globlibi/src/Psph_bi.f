...
c       the value of the (scaled) magnetic potential for
c
c       sthe scaling is 1/ra
c
c       internal sources only. 
...
c       
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	subroutine Psph_bi(ry,nlis,nlie,nti,pos,be)
c
        implicit none
c
...
c   im=0
        ...
        do il=nlis,nlie
          nu=(il*il-1)*nti-nus
          be(nu+1)=dlf(il-im+1)*(ra/pos(3))**(il+1)
          do it=2,nti
