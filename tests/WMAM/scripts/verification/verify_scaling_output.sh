...
# REFERENCE_HOME="~/../shared/arc/720/Results"
  REFERENCE_HOME="/work/ecsead08/ecsead08/mrbad08/tests/WMAM/results//720/cce12/cmpich8-ofi/n2/c256/2528530/Results"
elif [ ${DEGREE} -eq 1440 ]; then
# REFERENCE_HOME="~/../shared/arc/mod_wdmam_4Nick_1024/Results"
  REFERENCE_HOME="/work/ecsead08/ecsead08/mrbad08/tests/WMAM/results/scaling/3.0/1440/cce12/cmpich8-ofi/n128/c16384/2034985/Results"
