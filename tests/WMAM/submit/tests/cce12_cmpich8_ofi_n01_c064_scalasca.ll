...
APP_EXE=${ROOT}/apps/${APP_NAME}/${APP_VERSION}/${PE_NAME}/${PE_VERSION}/scalasca/bin/${APP_EXE_NAME}
...
export SCOREP_EXPERIMENT_DIRECTORY=${APP_RUN_PATH}/scorep
...
#scalasca ${SCALASCA_PARAMS} srun ${SRUN_PARAMS} ${APP_EXE} ${APP_PARAMS} &>> ${APP_OUTPUT}
...
mv ${APP_RUN_PATH}/scorep ${APP_RUN_PATH}/${SLURM_JOB_ID}/
