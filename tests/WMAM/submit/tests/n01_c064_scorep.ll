...
APP_EXE=${ROOT}/apps/${APP_NAME}/${APP_VERSION}/${PE_NAME}/${PE_RELEASE}/scorep/bin/${APP_EXE_NAME}
...
export SCOREP_FILTERING_FILE=${APP_RUN_PATH}/2100419/scorep/initial_scorep.filter
