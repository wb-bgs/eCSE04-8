...
#NSYS_PARAMS="profile --trace=mpi,openmp,cuda --mpi-impl=openmpi --cuda-memory-usage=true --output=wmam-baseline"
...
#nsys ${NSYS_PARAMS} srun ${SRUN_PARAMS} ${APP_EXE} ${APP_PARAMS}
